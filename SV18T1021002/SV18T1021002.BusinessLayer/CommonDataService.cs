...
using SV18T1021002.DataLayer;
using SV18T1021002.DomainModel;
using SV18T1021002.DataLayer.SQLServer;

namespace SV18T1021002.BusinessLayer
{
    /// <summary>
    ...
    public static class CommonDataService
    {
        ...
        private static readonly CheckEmail checkDB;
        private static readonly ICommomDAL<ProductPhoto> productPhotoDB;
        private static readonly ICommomDAL<ProductAttribute> productAttributeDB;
        ...
        static CommonDataService()
        {
            ...
            if (provider == "SQLServer")
            {
                ...
                checkDB = new DataLayer.SQLServer.CheckEmail(connectionString);
        ...
        /// <summary>
        /// Lấy thông tin nhân viên theo id//0347266936//0909426604
        /// </summary>
        /// <param name="categoryID"></param>
        /// <returns></returns>
