...
namespace SV18T1021002.WEB.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        public ActionResult Search(Models.PaginationSearchInput input)
        {
            ...
            Models.EmployeeBasePaginationResult model = new Models.EmployeeBasePaginationResult
            {
                Page = input.Page,
        ...
        public ActionResult Save(
             Employee model, HttpPostedFileBase uploadPhoto, string dateOfBirth)
        {
            ...
            {
                if (CommonDataService.CheckEmail(model.Email))
                {
