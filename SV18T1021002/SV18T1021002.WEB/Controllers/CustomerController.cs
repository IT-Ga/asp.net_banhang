...
namespace SV18T1021002.WEB.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        public ActionResult Search(Models.PaginationSearchInput input)
        {
            ...
            Models.CustomerBasePaginationResult model = new Models.CustomerBasePaginationResult
            {
                Page = input.Page,
        ...
        public ActionResult Save(Customer model)
        {
            ...
            {
                ViewBag.Title = model.CustomerID == 0 ? "Bổ sung khách hàng còn thiếu ?" : "Cập nhật thông tin khách hàng";
                return View("Create",model);
            }    
